...
import { registerUser, loginUser, logoutUser, refreshAccessToken, getCurrentUser,
    changeCurrentPassword, updateAccountDetails, updateUserAvatar, updateUserCoverImage
...
// userRouter.route("/c/:user").get(verifyJWT, getUserChannelProfile)
userRouter.route("/c/:user").get(getUserChannelProfile)
